...
class TalkingHead {
  ...
  */
  stopSpeaking() {
    try { this.audioSpeechSource.stop(); } catch(error) {console.log(error)}
    this.audioPlaylist.length = 0;
  ...
  */
  ...
  async replaceAndSpeakNewAudio(newAudio, options = null, onSubtitles = null) {
